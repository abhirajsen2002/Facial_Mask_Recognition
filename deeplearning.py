...
# label 
labels = ['Mask Detected', 'No Mask Detected', 'Mask covering Mouth and Chin detected', 'Mask covering Nose and Mouth detected']
...
def getColor(label):
    if label == "Mask Detected":
        ...
        color = (0,0,255)
    elif label == 'Mask covering Mouth and Chin detected':
        color = (0,255,255)
    else:
        color = (255,255,0)
